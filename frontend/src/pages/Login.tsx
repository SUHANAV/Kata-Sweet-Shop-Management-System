  ...
  return (
    <div className="max-w-md mx-auto bg-gray-800 p-6 rounded shadow">
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <button className="w-full p-2 bg-amber-500 rounded">Login</button>
      </form>
      <p className="mt-4 text-sm">No account? <Link className="text-amber-400" to="/register">Register</Link></p>
    </div>
  );
}
